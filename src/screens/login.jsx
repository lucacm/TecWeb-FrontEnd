...
export default function Login() {
  ...
  function confirmSenha(user, password) {
    axios
      .get("https://tecweb-back-champions.herokuapp.com/userlist")
      .then((resp) => {
  ...
  return (
    <div className="container">
      ...
      <div className="card">
        <p className="label">
          Entre na plataforma e acompanhe a Champions League!
        </p>
      ...
      <button className="button" onClick={() => history.push("./subscribe")}>
        Cadastre-se
      </button>
    </div>
  );
